...
SITE_URL = config('SITE_URL', default='https://hypehavenhub.in')
...
SHIPROCKET_EMAIL = config('SHIPROCKET_EMAIL', default='api@hypehavenhub.in')
SHIPROCKET_PASSWORD = config('SHIPROCKET_PASSWORD', default='j&*uaonGyV383bQeJ5orJoTOqOAunK9l')
SHIPROCKET_CHANNEL_ID = config('SHIPROCKET_CHANNEL_ID', default='8087473')
SHIPROCKET_CHANNEL_ID_2 = config('SHIPROCKET_CHANNEL_ID_2', default='11415622')
SHIPROCKET_PICKUP_LOCATION = config('SHIPROCKET_PICKUP_LOCATION', default='abhi')
...
SHIPROCKET_BRAND_SUBDOMAIN = config('SHIPROCKET_BRAND_SUBDOMAIN', default='hypehavenhub')
