...
urlpatterns = [
    ...
    path('admin/clear-fake-data/', admin_views.admin_clear_fake_data, name='admin_clear_fake_data'),
    ...
    path('admin/products/variants/<int:pk>/delete/', admin_views.admin_variant_delete, name='admin_variant_delete'),
    ...
    path('admin/orders/sync-shiprocket-statuses/', admin_views.admin_sync_shiprocket_statuses, name='admin_sync_shiprocket_statuses'),
