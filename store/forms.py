...
class HeroPanelForm(forms.ModelForm):
    class Meta:
        model = HeroPanel
        fields = ['title', 'background_text', 'image', 'image_url', 'bg_color', 'panel_color', 'link', 'order', 'is_active']
        widgets = {
            'title': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. Ruby Stone Long Jhumka'}),
            'background_text': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. RUBY STONE LONG JHUMKA (Text behind photo)'}),
            'image': forms.FileInput(attrs={'class': 'form-control'}),
            'image_url': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'Cloudflare R2 / Image URL'}),
            'bg_color': forms.TextInput(attrs={'class': 'form-control form-control-color w-100', 'type': 'color'}),
            'panel_color': forms.TextInput(attrs={'class': 'form-control form-control-color w-100', 'type': 'color'}),
            'link': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'https://... or /products/'}),
